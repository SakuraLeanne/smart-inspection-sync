-- 目标表DDL（MySQL 5.7 / utf8mb4）
-- 按需求创建四张表
CREATE TABLE IF NOT EXISTS ic_raw_customer_service (
...
CREATE TABLE IF NOT EXISTS ic_raw_customer_service_history (
  source_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS ic_sync_task_checkpoint (
...
CREATE TABLE IF NOT EXISTS ic_sync_task_log (
