    ...
    public int[] upsertBatch(List<CustomerServiceRow> rows, String batchNo) {
        ...
        return mysqlJdbcTemplate.batchUpdate(sql, new BatchPreparedStatementSetter() {
            public void setValues(java.sql.PreparedStatement ps, int i) throws java.sql.SQLException {
                ...
                ps.setObject(11, r.getComment());
                ps.setString(12, r.getCommentContent());
                ps.setObject(13, r.getComplaintStatus());
                ps.setTimestamp(14, toTs(r.getConfirmTime()));
                ps.setString(15, batchNo);
            }
