...
public class CusStandardTableBuildService {
    ...
    private static class SqlHolder {
        ...
        private static final String BUILD_STD_WORK_ORDER = "INSERT INTO cus_std_work_order (" +
            "source_system,source_order_id,order_no,project_id,project_name,source_region_id,location_id,location_name,location_text,customer_id,report_person,phone," +
            ...
            "SELECT 'property',cs.source_id,cs.voucher_no,NULL,org.name,cs.region_id,NULL,NULL,NULL,NULL,cs.customer_name,cs.phone,cs.service_source," +
